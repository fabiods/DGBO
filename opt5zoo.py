...
#         quit()
    ...
    if nn==13:
        res=subprocess.run(  "~/DGBO/basrun.sh " + str(yy[0]) + " " + str(yy[1]) + " " + str(yy[2])+ " " + str(yy[3]) + " " + str(yy[4]) + " " + str(yy[5])+ " " + str(yy[6]) + " " + str(yy[7])  + " " + str(yy[8])  + " " + str(yy[9]) + " " + str(yy[10]) + " " + str(yy[11]) + " " + str(yy[12]), shell=True, stdout=subprocess.PIPE)
    if nn==15:
    ...
    if nn==18:
         res=subprocess.run(  "~/DGBO/basrun.sh " + str(yy[0]) + " " + str(yy[1]) + " " + str(yy[2])+ " " + str(yy[3]) + " " + str(yy[4]) + " " + str(yy[5])+ " " + str(yy[6]) + " " + str(yy[7])  + " " + str(yy[8])  + " " + str(yy[9]) + " " + str(yy[10]) + " " + str(yy[11]) + " " + str(yy[12])+ " " + str(yy[13]) + " " + str(yy[14]) + " " + str(yy[15])+ " " + str(yy[16]) + " " + str(yy[17]  ), shell=True, stdout=subprocess.PIPE)
...
#print(x0.get_x())
    budget = min(abs(allsize),1000 * dim_size)  # number of calls to the objective function
    print("budget",budget)
